...
db.run("INSERT INTO comments (commentsbody, location, topics_id) VALUES ('squarespace is cool', 'staten island, NY, US', 2)" );
db.run("INSERT INTO comments (commentsbody, location, topics_id) VALUES ('songs are calming', 'manhattan, NY, US', 3)" );
db.run("INSERT INTO comments (commentsbody, location, topics_id) VALUES ('poems are fun', 'brooklyn, NY, US', 4)" );
db.run("INSERT INTO comments (commentsbody, location, topics_id) VALUES ('chrome books are handy', 'bronx, NY, US', 5)" );
db.run("INSERT INTO comments (commentsbody, location, topics_id) VALUES ('japanese is my favorite', 'queens, NY, US', 6)" );